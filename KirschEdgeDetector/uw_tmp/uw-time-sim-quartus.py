...
# xsys( "vcom -93 +acc -work work-msim  uw_tmp/kirsch_chip.v uw_tmp/kirsch_chip.vhd string_pkg.vhd kirsch_synth_pkg.vhd kirsch_unsynth_pkg.vhd kirsch_tb.vhd")
...
#------------------------------------------------------------------------
# run simulation
xsys( "vsim -lib work-msim -c    -sdfmax uut/chip=uw_tmp/kirsch_chip.sdf -wlf uw_tmp/vsim.wlf -t 1ns -do uw_tmp/uw-sim.tcl kirsch_tb")
